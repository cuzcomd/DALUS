...
1. Erzeugen Sie die Datanbank 'dalus', indem Sie die Datei dalus.sql in Ihrem Webserver importieren
...
4. Tragen Sie die Zugangsdaten Ihrer Datenbank in die Datei [config.php](config.php) ein
